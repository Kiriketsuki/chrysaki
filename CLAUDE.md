...
This project is indexed by GitNexus as **chrysaki-ralph-ags-notification-center-T10** (88 symbols, 101 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/chrysaki-ralph-ags-notification-center-T10/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T10/context` | Codebase overview, check index freshness |
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T10/clusters` | All functional areas |
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T10/processes` | All execution flows |
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T10/process/{name}` | Step-by-step execution trace |
