...
This project is indexed by GitNexus as **chrysaki-ralph-ags-notification-center-T7** (88 symbols, 101 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/chrysaki-ralph-ags-notification-center-T7/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T7/context` | Codebase overview, check index freshness |
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T7/clusters` | All functional areas |
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T7/processes` | All execution flows |
| `gitnexus://repo/chrysaki-ralph-ags-notification-center-T7/process/{name}` | Step-by-step execution trace |
